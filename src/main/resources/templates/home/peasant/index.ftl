...
<div class="top clearfix" id ="user-top">
    ...
    <div id="user_photo">
          	<#if lssf_peasant.headPic??>
          	<img id="origin_ph" onClick="openUploadPanel()" src="/photo/view?filename=${lssf_peasant.headPic}" old-src="/photo/view?filename=${lssf_peasant.headPic}" alt="大头像">
			<#else>
        ...
        <div id="my_info">
            <div id="account_info">
				...
				<ul class="infos" id="userid">
					<li>序号</li><li class="right_info">${lssf_peasant.id}</li>
				</ul>
			    <ul class="infos" id="userstate">
				    <li>账号状态</li>
				    <li class="right_info"><#if lssf_peasant.status == 1>正常<#else>冻结</#if></li>
				</ul>
			</div>
            <div id="account_info">
                <ul class="infos">
                    <li>账号ID</li>
                    <li class="right_info">${lssf_peasant.pn}</li>
                </ul>
            </div>
            <div id="base_info">
            ...
            <div id="base_info">
                ...
                <ul class="infos">
                    <li>昵称</li>
                    <li class="right_info">
                        <span class="baseinfo" id="nickname_span">${lssf_peasant.nickname!""}</span>
                        <input class="baseinfo" value="${lssf_peasant.nickname!""}" id="nickname" type="text">
                    </li> 
                </ul>
                <ul class="infos">
                    <li>手机</li>
                    <li class="right_info">
                        <span class="baseinfo" id="phone_span">${lssf_peasant.mobile!""}</span>
                        <input class="baseinfo" value="${lssf_peasant.mobile!""}" id="mobile" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>QQ</li>
                    <li class="right_info">
                        <span class="baseinfo" id="qq_span">${lssf_peasant.qq!""}</span>
                        <input class="baseinfo" value="${lssf_peasant.qq!""}" id="qq" type="text">
                    </li>
                </ul>
               <#-- <ul class="infos">
                    <li>学院</li>
              ...
              <div id="onsale_pro">
                <#if wantedGoodsList??>
                 ...
                 <div class="enshr_each" id="">  
	                    ...
	                    <a href="">
	                        <#if wantedGoods.peasant.headPic??>
	                        <img class="enshr_ph" src="/photo/view?filename=${wantedGoods.peasant.headPic}" alt="${wantedGoods.name}">
	                        <#else>
