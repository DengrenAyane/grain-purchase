                        	...
                        	<div class="want-li clearfix">
                        		<div class="left">
                        			<a href="">
                        				...
                        				<img src="/photo/view?filename=${wantedGoods.peasant.headPic}" alt="头像">
                        				<#else>
                        		...
                        		<div class="right">
                        			...
                        			<p class="want-contact">
                        				<p class="want-person">${wantedGoods.peasant.nickname!""}</p>
                        				<span class="mr10">TEL：${wantedGoods.peasant.mobile!""}</span>
                        				<span>QQ：${wantedGoods.peasant.qq!""}</span>
                        			</p>
                        		</div>
                        	</div>
                        </li>
