        ...
        <div class="main center clearfix">
                ...
                <div class="ershou-info">
                    <div class="ershou-hd">
                        ...
                        <div class=" discount">
                        	...
                        	<span class="ershou-price">出售价：${goods.sellPrice}</span>
                        </div>
                    ...
                    <ul class="ershou-detail">
                        ...
                        <li class="ershou-seller">
                        	...
                        	<div class="value">
                        		<span class="value-name" id="userid">${goods.peasant.nickname!goods.peasant.pn}</span>
                        	</div>
                        </li>
                    </ul>
                    <div id="buy-button" >
            ...
            <div class="ershou-desc">
            	<div class="desc clearfix">
            		<a href=""target="_top">
            			<#if goods.peasant.headPic??>
            			<img id="user_ph" src="/photo/view?filename=${goods.peasant.headPic}">
            			<#else>
				...
				<div class="comments-wr" style="border-left:0px;">
					<div class="comment-wr">
						<div class="post-comment clearfix">
								...
								<img class="avatar" src="/photo/view?filename=${lssf_peasant.headPic}" alt="头像"/>
								<#else>
									...
									<div class="comments-wr" style="border:0px;">
										<div class="comment-wr">
											...
											<div class="comment" style="margin-top:25px;">
												<#if comment.peasant.headPic??>
												<img class="avatar" src="/photo/view?filename=${comment.peasant.headPic}" alt="头像"/>
												<#else>
												<img class="avatar" src="/home/imgs/avatar1.png" alt="头像"/>
												</#if>
												<div class="commentator" style="padding-left:55px;padding-bottom:5px;color:rgb(75, 192, 165);border-bottom: 1px dashed rgb(75, 192, 165);">
													<b>${comment.peasant.nickname!comment.peasant.pn}</b>
												...
												<div class="man" style="padding-left:55px;padding-bottom:5px;">
													<a class="rpl" href="#comment-content" data-reply="${comment.content}" data-name="${comment.peasant.nickname!comment.peasant.pn}">回复</a>
												</div>
											</div>
											</#list>
										</div>
...
$(document).ready(function(){
   ...
   $("#to-login-btn").click(function(){
	...
	$("#submit-comment-btn").click(function(){
		...
		ajaxRequest('/home/peasant/comment','post',data,function(){
			alert('评论成功');
...
function report(id){
	...
	ajaxRequest('/home/peasant/report_goods','post',{'goods.id':id,content:content},function(){
		alert('举报成功');
	});
}
</script>	
