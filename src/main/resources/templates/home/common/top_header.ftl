	            ...
	            <div class="search-box center" >
	               <button  class="search-submit" id="search-button" onclick="searchPro()">搜索</button> 
	                <div class="input-wr">
	                    ...
	                    <input name="keyword" id="keyword" x-webkit-speech="" placeholder="搜索你想收购的粮食" value="${name!""}" type="text">
	                    </div>
	                </div>
	            </div>
	        ...
	        <div class="ease2 log-reg" id="have-not-login">
		        ...
		        <div id="have_login" class="clearfix">
		        	<div id="person_info" class="clearfix">
		        		<a href="../peasant/index">
		        			<#if lssf_peasant.headPic??>
		        			<img  class="avatar"  style="height:48px;width:48px;" src="/photo/view?filename=${lssf_peasant.headPic}">
		        			<#else>
		        			<img  class="avatar"  style="height:48px;width:48px;" src="/home/imgs/avatar1.png">
		        			</#if>
		        		</a>
			        	<div  style="display:inline;"  class="person_name">
			        		<a href="../peasant/index" id="id-btn">Hi：${lssf_peasant.nickname!lssf_peasant.pn}</a>
			        	</div>
			        	<div  style="display:inline;"  class="person_name">
