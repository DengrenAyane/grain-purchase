...
public class CodeMsg {
	...
	public static CodeMsg USER_SESSION_EXPIRED = new CodeMsg(-6, "还未登录或会话已失效，请重新登录！");
	...
	//后台用户管理
	public static CodeMsg ADMIN_PEASANT_NO_EXIST = new CodeMsg(-9100, "用户不存在！");
	public static CodeMsg ADMIN_PEASANT_STATUS_NO_CHANGE = new CodeMsg(-9101, "用户状态未发生变化！");
	public static CodeMsg ADMIN_PEASANT_STATUS_ERROR = new CodeMsg(-9102, "用户状态错误！");
	public static CodeMsg ADMIN_PEASANT_EDIT_ERROR = new CodeMsg(-9103, "用户编辑错误，请联系管理员！");
	public static CodeMsg ADMIN_PEASANT_DELETE_ERROR = new CodeMsg(-9104, "该用户下存在关联数据（物品、求购物品、评论、举报信息等），请先删除关联数据再操作！");
	...
	//前端用户登录注册类错误码
	public static CodeMsg HOME_PEASANT_REGISTER_SN_EXIST = new CodeMsg(-10000, "该用户ID已存在，请勿重复注册！");
	public static CodeMsg HOME_PEASANT_REGISTER_ERROR = new CodeMsg(-10001, "注册失败，请联系管理员！");
	public static CodeMsg HOME_PEASANT_SN_NO_EXIST = new CodeMsg(-10002, "该用户ID不存在！");
	public static CodeMsg HOME_PEASANT_PASSWORD_ERROR = new CodeMsg(-10003, "密码错误！");
	public static CodeMsg HOME_PEASANT_UNABLE = new CodeMsg(-10003, "该用户已被冻结，请联系管理员！");

	//前端用户中心错误码
	public static CodeMsg HOME_PEASANT_EDITINFO_ERROR = new CodeMsg(-20000, "基本信息修改失败，请联系管理员！");
	public static CodeMsg HOME_PEASANT_EDITPWD_OLD_ERROR = new CodeMsg(-20001, "原密码错误！");

	//前端用户发布物品错误码
	public static CodeMsg HOME_PEASANT_PUBLISH_ERROR = new CodeMsg(-30000, "粮食发布失败，请联系管理员！");
	public static CodeMsg HOME_PEASANT_GOODS_EDIT_ERROR = new CodeMsg(-30001, "粮食发布失败，请联系管理员！");
	public static CodeMsg HOME_PEASANT_GOODS_NO_EXIST = new CodeMsg(-30002, "粮食不存在！");
	public static CodeMsg HOME_PEASANT_PUBLISH_CATEGORY_EMPTY = new CodeMsg(-30003, "请选择粮食分类！");

	//前端用户举报物品
	public static CodeMsg HOME_PEASANT_REPORT_GOODS_ERROR = new CodeMsg(-40000, "举报失败，请联系管理员！");
	public static CodeMsg HOME_PEASANT_REPORTED_GOODS = new CodeMsg(-40001, "您已经举报过该物品，请勿重复举报！");
	public static CodeMsg HOME_PEASANT_REPORTED_NO_EXIST = new CodeMsg(-40002, "举报信息不存在！");

	//前端用户评论
	public static CodeMsg HOME_PEASANT_COMMENT_ADD_ERROR = new CodeMsg(-50000, "评论失败，请联系管理员！");
