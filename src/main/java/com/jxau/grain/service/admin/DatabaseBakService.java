...
import com.jxau.grain.dao.admin.DatabaseBakDao;
import com.jxau.grain.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${lssf.database.backup.dir}")
	private String backUpDir;
	@Value("${lssf.database.backup.username}")
	private String dbUsername;
	@Value("${lssf.database.backup.password}")
	private String dbPwd;
	@Value("${lssf.database.backup.database.name}")
