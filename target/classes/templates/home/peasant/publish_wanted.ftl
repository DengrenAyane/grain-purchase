  ...
  <#include "../common/top_header.ftl"/>
   <div class="container">
            <div class="main center">
                ...
                <div class="wantInfo-release-title">发布求购粮食</div>
                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input id="name" name="name" placeholder="最多18个字" maxlength="18" value="" type="text" class="required" tips="请填写粮食名称"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-item xl goods-desc">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <textarea name="content" id="desc" placeholder="建议填写粮食信息，至少15个字" class="required" tips="请填写详情描述"></textarea>
                                </div>
                            </div>
                        </div>
