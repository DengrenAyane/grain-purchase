...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
                ...
                <label class="input-tips" for="id">用户ID</label>
                <div class="inputOuter" id="uArea">
                    <input type="text" id="login-sn" name="pn" class="inputstyle" value=""/>
                </div>
                </div>
    ...
    <div class="web_login">
        ...
        <ul class="reg_form" id="reg-ul">
                ...
                <li>
                    ...
                    <label for="user"  class="input-tips2">用户ID：</label>
                    <div class="inputOuter2">
                        <input type="text" id="user-sn" name="pn" maxlength="12" class="inputstyle2"/>
                    </div>
