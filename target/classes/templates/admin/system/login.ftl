  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href=""> <img alt="light year admin" src="/admin/images/logo-sidebar_01.png"></a>
      </div>
      ...
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2020 <a href="${siteUrl!""}">DrAyaneShindou</a>. All right reserved</p>
      </footer>
    </div>
  </div>
</div>
