            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                      	<#if pn??>用户ID<#elseif name??>名称<#else>搜索条件</#if> <span class="caret"></span>
                      </button>
                    ...
                    <input type="text" class="form-control" value="${name!pn!""}" id="search-value" name="<#if pn??>peasant.pn<#else>name</#if>" placeholder="请输入搜索值">
              ...
              <div class="card-body">
                ...
                <ul class="pagination ">
                  ...
                  <#else>
                  <li><a href="list?<#if pn??>peasant.pn<#else>name</#if>=${name!pn!""}&currentPage=1">«</a></li>
                  </#if>
                  <#list pageBean.currentShowPage as showPage>
                  <#if pageBean.currentPage == showPage>
                  <li class="active"><span>${showPage}</span></li>
                  <#else>
                  <li><a href="list?<#if pn??>peasant.pn<#else>name</#if>=${name!pn!""}&currentPage=${showPage}">${showPage}</a></li>
                  </#if>
                  </#list>
                  <#if pageBean.currentPage == pageBean.totalPage>
                  <li class="disabled"><span>»</span></li>
                  <#else>
                  <li><a href="list?<#if pn??>peasant.pn<#else>name</#if>=${name!pn!""}&currentPage=${pageBean.totalPage}">»</a></li>
                  </#if>
