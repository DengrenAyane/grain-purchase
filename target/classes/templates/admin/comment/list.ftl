...
<title>${siteName!""}|粮食评论管理-${title!""}</title>
            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                      	<#if name??>粮食名称<#elseif pn??>用户ID<#elseif content??>评论内容<#else>搜索条件</#if> <span class="caret"></span>
                      </button>
              ...
              <div class="card-body">
                ...
                <ul class="pagination ">
                  ...
                  <#else>
                  <li><a href="list?<#if name??>goods.name<#elseif sn??>peasant.pn<#else>content</#if>=${name!pn!content!""}&currentPage=1">«</a></li>
                  </#if>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('粮食评论删除成功!',function(){
